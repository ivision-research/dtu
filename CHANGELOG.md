...
- **BREAKING** Completely removed the `DeviceDatabase` trait. This database will always be `sqlite` and it just added complexity and actually make things less efficient.
